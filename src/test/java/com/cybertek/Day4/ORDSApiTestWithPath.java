...
public class ORDSApiTestWithPath extends HRTestBase {
    ...
    public void test2(){
        ...
        List<String> allIT_PROGsFirstName = response.path("items.first_name");
        List<String> allIT_PROGsLastName =response.path("items.last_name");

        System.out.println(allIT_PROGsFirstName + " " );
        //HW
